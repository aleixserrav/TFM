...
# Instalar y activar Maria DB: sudo apt update; sudo apt install mariadb-server; sudo systemctl start mariadb; sudo systemctl enable mariadb;
# Añadir contraseña al usuario root: ALTER USER 'root'@'localhost' IDENTIFIED BY 'broker'; FLUSH PRIVILEGES;
